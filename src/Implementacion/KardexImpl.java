    ...
    public void crear(Kardex k) throws Exception {
        try {
            ...
            if (super.verifConexion() == true) {
                ...
                ps.setString(3, k.getCodigoC());
                ps.setString(4, k.getCodigoV());
                ps.setFloat(5, k.getCostoU());
        ...
        try {
            ...
            if (super.verifConexion() == true) {
                ...
                while (rs.next()) {
                    ...
                    k.setCodigoC(rs.getString("codigoC"));
                    k.setCodigoV(rs.getString("codigoV"));
                    k.setCodigo(rs.getString("codigo"));
                    k.setCostoU(rs.getFloat("costoU"));
